...
- Tasks assisted / week
- Time saved vs. review cost
- Rework rate (% corrected outputs)
...
- **Coaching & Enablement**: 1:1s, pair sessions, visible progress
- **AI Syncs**: agenda, decisions, alignment
- **Stakeholder Coverage**: areas served and expansion status
